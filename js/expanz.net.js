...
$(function () {
   ...
   var RequestObject = {
      ...
      CreateSession: function (username, password, appsite) {
         return {
            data: buildRequest('CreateSessionX', )(RequestBody.CreateSession(username, password, appsite)),
            url: 'CreateSessionX'
         };
      },
      ...
      GetSessionData: function (sessionHandle) {
         return {
            data: buildRequest('ExecX', 'http://www.expanz.com/ESAService', sessionHandle)(RequestBody.CreateGetSessionData()),
            url: 'ExecX'
         };
      },
