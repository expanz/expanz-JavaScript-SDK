function createActivityWithKendoTabs(tabElement,ajaxTabContents){
	...
	var onContentLoad  = function (e) {
		   ...
		   if ( Object.size(tabLoaded) == nbDynamicTabs){
			   ...
			   expanz.CreateActivity($(e.item).parents('[bind=activity]'));
			   //$(this).show();
		   }
		   //expanz.CreateTab($(e.item).parents('[bind=activity]').attr('name'),e.contentElement);
	 };
